...
__all__ = ['SVDNoiseUnet', 'SVDNoiseUnet_Concise', 'FlowSVDNoiseUnet', 'W2S_SVDNoiseUnet', 'SVDNoiseUnet_wo_attention']
...
class SVDNoiseUnet_wo_attention(nn.Module):
    def __init__(self, in_channels=4, out_channels=4, resolution=128): # resolution = size // 8
        super(SVDNoiseUnet_wo_attention, self).__init__()
